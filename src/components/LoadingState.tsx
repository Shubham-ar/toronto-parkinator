...
export default function LoadingState() {
  return (
    <motion.div
      className="absolute inset-0 flex items-end justify-center z-30 pointer-events-none"
    ...
    >
      <motion.div
        className="flex flex-col items-center gap-4 px-10 py-7 rounded-3xl pointer-events-auto"
        style={{
